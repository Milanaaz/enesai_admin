...
function CoursesPage() {
  ...
  return (
    <section className="admin-page courses-page">
            ...
            <>
              <header className="course-detail-header">
                ...
                <div className="course-detail-actions">
                  <button type="button" className="courses-secondary-btn" onClick={() => openCourseModal('edit')}>Редактировать</button>
          ...
          {courseDetail && selectedModule && !selectedLessonId && !scopeTest ? (
            <>
              <header className="course-detail-header">
                ...
                <div className="course-detail-actions">
                  <button type="button" className="courses-secondary-btn" onClick={() => openModuleModal('edit', selectedModule)}>Редактировать модуль</button>
          ...
          {courseDetail && selectedLesson ? (
            <>
              <header className="course-detail-header">
                ...
                <div className="course-detail-actions">
                  <button type="button" className="courses-secondary-btn" onClick={() => openLessonModal('edit', selectedLesson)}>Редактировать урок</button>
      ...
      {modal?.type === 'course' ? (
        <Modal title={modal.mode === 'edit' ? 'Редактировать курс' : 'Создать курс'} onClose={() => setModal(null)} onSubmit={saveCourse} busy={busy === 'save-course'}>
          <CourseForm form={courseForm} setForm={setCourseForm} />
        </Modal>
      ) : null}

      {modal?.type === 'module' ? (
        <Modal title={modal.mode === 'edit' ? 'Редактировать модуль' : 'Создать модуль'} onClose={() => setModal(null)} onSubmit={saveModule} busy={busy === 'save-module'}>
          <ModuleForm form={moduleForm} setForm={setModuleForm} />
        </Modal>
      ) : null}

      {modal?.type === 'lesson' ? (
        <Modal title={modal.mode === 'edit' ? 'Редактировать урок' : 'Создать урок'} onClose={() => setModal(null)} onSubmit={saveLesson} busy={busy === 'save-lesson'}>
          <LessonForm form={lessonForm} setForm={setLessonForm} />
        </Modal>
      ) : null}

      {modal?.type === 'word' ? (
        <Modal title={modal.mode === 'edit' ? 'Редактировать слово' : 'Создать слово'} onClose={() => setModal(null)} onSubmit={saveWord} busy={busy === 'save-word'}>
          <WordForm form={wordForm} setForm={setWordForm} />
        </Modal>
      ) : null}

      {modal?.type === 'exercise' ? (
        <Modal title={modal.mode === 'edit' ? 'Редактировать упражнение' : 'Создать упражнение'} onClose={() => setModal(null)} onSubmit={saveExercise} busy={busy === 'save-exercise'}>
